...
public class Remover_Conta_Receber extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Remover_Conta_Receber
     */
    public Remover_Conta_Receber() 
    {
        ...
        listModel = a.loadListModel("receber");
        ...
        if(!contas_list.isSelectionEmpty())
        {
            ...
            if(x == 0)
            {
                try {
                    ...
                    Logger.getLogger(Remover_Conta_Receber.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Remover_Conta_Receber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    {
        Armazenamento_File a = new Armazenamento_File();
        Financeiro f = a.loadConta("remover");
        Operacoes_Contas oc = new Operacoes_Contas();
        
        int id = contas_list.getSelectedIndex();
        oc.remover(f, id, "remover");
        try 
        {
            a.salvarConta(f, "remover");
        } catch (IOException ex) 
        {
