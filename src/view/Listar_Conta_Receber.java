 ...
 * @author Cícero
 */
public class Listar_Conta_Receber extends javax.swing.JFrame {
    ...
    public void Listar()
    {
        ...
        try 
        {
            ...
            for(int i = 0; i < f.getContas_receber().size(); i++)
            {
                ...
                contas_list.append("Data: " + f.getContas_receber().get(i).getData() + "\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Listar_Conta_Receber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Listar_Conta_Receber().setVisible(true);
            }
        });
    }
