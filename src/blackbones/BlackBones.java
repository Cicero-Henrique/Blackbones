...
public class BlackBones 
{
    public static void main(String[] args) 
    {
        ...
        /*Editar_Produto l = new Editar_Produto();
        l.setVisible(true);*/
        
        /*Listar_Produtos e = new Listar_Produtos();
        e.setVisible(true);*/
        
        /*Registrar_Produto rp = new Registrar_Produto();
        rp.setVisible(true);*/
        
        /*Vender_Produtos rc = new Vender_Produtos();
        rc.setVisible(true);*/
